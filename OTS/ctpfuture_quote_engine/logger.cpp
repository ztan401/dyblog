...
namespace flow::utils {
    bool init_console_logger(const std::string &level, bool show_use_level, bool use_format) {
        try {
            // console
            if (use_format) {
    ...
    bool init_logger(const std::string &level, const std::string &log_file, bool use_async, bool show_use_level,
                     bool use_format) {
        {
            try {
                // console
