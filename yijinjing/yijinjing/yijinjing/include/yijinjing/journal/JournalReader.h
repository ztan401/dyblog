...
#include "yijinjing/journal/Frame.hpp"// for inline function
#include "yijinjing/journal/IJournalVisitor.h"
#include "yijinjing/journal/Journal.h"// for inline function
#include "yijinjing/journal/JournalHandler.h"
...
public:
    // creators
    static JournalReaderPtr create(const vector<string> &dirs, const vector<string> &jnames,
                                   int64_t startTime, const string &readerName);

    static JournalReaderPtr create(const vector<string> &dirs, const vector<string> &jnames,
                                   const vector<IJournalVisitor *> &visitors, int64_t startTime,
                                   const string &readerName);

    static JournalReaderPtr create(const string &dir, const string &jname, int64_t startTime,
                                   const string &readerName);

    static JournalReaderPtr create(int64_t startTime, const string &readerName);
